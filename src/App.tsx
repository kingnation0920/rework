...
const ROUTE_META: Record<string, { title: string; description: string }> = {
  ...
  '/blog/hr-mega-trend-ai-work-redesign': {
    title: 'HR 메가 트랜드 AI 시대의 워크 리디자인 | 랩리워크 블로그',
...
const BLOG_POSTS: BlogPost[] = [
  {
    ...
    title: 'HR 메가 트랜드 AI 시대의 워크 리디자인, 도구 도입을 넘어 일의 본질을 바꾸는 법',
    description: '생성형 AI의 진정한 가치는 단순한 기능 습득이 아니라 업무 프로세스를 해체하고 다시 조립하는 설계 능력에 있습니다.',
    category: 'AI HRD',
    date: '2026-06-25',
    readTime: '8분',
    tags: ['HR 메가 트랜드', '워크 리디자인', '생성형 AI', '직무재설계', 'AI HRD', '디지털 전환', '업무자동화', '조직전략'],
    paragraphs: [
      ...
      '최근 한 유통 기업 미팅룸에서 리더분들과 마주 앉았을 때의 일입니다. 사내에 여러 생성형 AI 계정을 지급했지만 실무진의 활용률은 제자리걸음이었고, 정작 중요한 핵심 업무에는 여전히 시간이 부족하다는 불만이 터져 나오고 있었습니다. 이는 요즘 많은 조직이 마주한 HR 메가 트랜드 AI 시대의 워크 리디자인에 대한 핵심적인 고민입니다.',
      '그렇다면 우리가 당면한 HR 메가 트랜드 AI 시대의 워크 리디자인이란 무엇일까요? 이것은 단순히 새로운 소프트웨어를 설치하는 기술적 도입을 뜻하지 않으며, 조직 구성원이 매일 수행하는 직무의 세부 과업을 완벽하게 분해하고 재결합하여 기술과 인간이 가장 이상적인 시너지를 내도록 일의 생태계를 다시 설계하는 일련의 조직 전략을 말합니다.',
      ...
      'HR 메가 트랜드 AI 시대의 워크 리디자인 프로젝트는 조직에 언제 가장 필요한가요?',
